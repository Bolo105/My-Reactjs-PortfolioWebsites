...
export const BooksAuthors = () => {
  const [popularBooks, setPopularBooks] = useState([]);
  const searchTerm = "authors:Anthony Robbins"; // Término de búsqueda para autosuperación y ayuda
 const maxResults = 5; // Número máximo de resultados que deseamos obtener
...
const apiUrl = `https://www.googleapis.com/books/v1/volumes?q=${searchTerm}&maxResults=${maxResults}&key=AIzaSyDRQ4k1QTLNf4KV2W4kd0Gx4MaDM8zveb8`;
  ...
  return (
    <div id='booksauthors' className="container">
